...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/git-print-all-diff/git-print-all-diffs.py) -->
<!-- The below code snippet is automatically added from ../../python/git-print-all-diff/git-print-all-diffs.py -->
```py
import subprocess
import shutil
import os
