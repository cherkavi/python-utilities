...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/spark-kafka/spark-kafka-json.py) -->
<!-- The below code snippet is automatically added from ../../python/spark-kafka/spark-kafka-json.py -->
```py
