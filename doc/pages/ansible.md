...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/ansible/libraries/openshift-wait/openshift-wait-for-start.py) -->
<!-- The below code snippet is automatically added from ../../python/ansible/libraries/openshift-wait/openshift-wait-for-start.py -->
```py
ANSIBLE_METADATA = {
