...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/xmind-todo-parser/education-advicer.py) -->
<!-- The below code snippet is automatically added from ../../python/xmind-todo-parser/education-advicer.py -->
```py
#!/usr/bin/env python
"""
