...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/proxy/foxyproxy-generator.py) -->
<!-- The below code snippet is automatically added from ../../python/proxy/foxyproxy-generator.py -->
```py
