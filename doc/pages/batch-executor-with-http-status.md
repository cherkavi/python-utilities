...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/batch-executor-with-http-status/notifier.py) -->
<!-- The below code snippet is automatically added from ../../python/batch-executor-with-http-status/notifier.py -->
```py
import os
import time
import subprocess
