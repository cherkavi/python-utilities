...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/http-executor/http-executor.py) -->
<!-- The below code snippet is automatically added from ../../python/http-executor/http-executor.py -->
```py
#!/usr/bin/env python3
