...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../python/xml-archimate2svg/update-archimate.py) -->
<!-- The below code snippet is automatically added from ../../python/xml-archimate2svg/update-archimate.py -->
```py
"""
